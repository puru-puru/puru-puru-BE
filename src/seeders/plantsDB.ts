export const plantsDB = [
    ...
    },
    {
        plantName: '자엽풍년화',
        type: '조록나무과',
        image: 'https://img.marieclairekorea.com/2021/04/mck_6066942a69ec2.jpg',
        content: '개성적인 색깔과 모양. 봄에 알록달록한 색깔의 꽃을 핀다. 햇빛과 통풍이 잘 드는 곳에 놓아야 할 것.',
        tag: '#다채로운'
    },
    {
        plantName: '멜라니 고무나무',
    ...
    },
    {
        plantName: '관음죽',
        type: '종려과',
        image: 'https://flower-lab.kr/web/product/big/M1008.jpg',
        content: '공기 정화에 좋기로 유명한 식물. 냄세 제거 능력 또한 뛰어나다. 자라는 속도는 느리나, 키우기는 어렵지 않다.',
        tag: '#상쾌한'
    },
    {
        plantName: '란타나',
    ...
    },
    {
        plantName: '오색 마삭줄',
        type: '협죽도과',
        image: 'https://img.marieclairekorea.com/2021/04/mck_606694e7977c6.jpg',
        content: '다채로운 잎 색이 있다고 하여 "오색"이라는 말이 붙었다. 실내에서 사육해야 하며, 특별한 관리 없이 잘 자란다.',
        tag: '#다채로운'
    },
    {
        plantName: '제라늄 엑스칼리버',
        type: '쥐손이풀과',
        image: 'https://img.marieclairekorea.com/2021/04/mck_606694642160c.jpg',
        content: '건조한 환경에서도 잘 자라는 것이 특징. 햇빛과 통풍은 필수이며, 잘만 관리하면 화려한 꽃망울을 터트린다.',
        tag: ' '
    },
    {
        plantName: '보리싸리',
        type: '콩과',
        image: 'https://img.marieclairekorea.com/2021/04/mck_6066946a2cd30.jpg',
        content: '본래 호주에서 자생하던 야생화로, 봄이 오면 가지 사이로 꽃망울을 터트리는게 매력.',
        tag: '#낭만적인'
    },
    {
        plantName: '아레카 야자',
        type: '종려과',
        image: 'https://www.costco.co.kr/medias/sys_master/images/h52/h35/79192617451550.webp',
        content: 'NASA가 지정한 실내공기 정화 식물 중 일등공신! 야자의 일종으로, 따뜻한 곳에서 키워야 한다.',
        tag: '#상쾌한'
    },
    {
        plantName: '장미 허브',
        type: '꿀풀과',
        image: 'https://www.costco.co.kr/medias/sys_master/images/h52/h35/79192617451550.webp',
        content: '다육식물 중 일종으로, 기르기 쉬운 식물이다. 다만 물을 적당히 줘야 할 것. 향을 목적으로 많이 키운다.',
        tag: '#향기로운'
    },
    {
        plantName: "스투키",
        type: "다육식물",
        image: "https://m.simpol.co.kr/data/shopimages/multi/302417869/202211/01_004025000003763216.jpg",
        content: "평균 월 1회 이하로 물을 주어야 합니다. 온도 부분으로는 평균 실내 온도 에서 잘 자라며, 한겨울의 추위만 주의",
        tag: "#상쾌한"
    },
    {
        plantName: "호야",
        type: "다육식물",
        image: "https://cdn.pixabay.com/photo/2015/06/15/15/47/hoya-bella-810312_1280.jpg",
        content: "여름에는 일주일에 한번, 겨울에는 보름에 한번 정도만 물을 주어도 잘 자라는 생명력이 강한 식물 입니다 !",
        tag: ""
    },
    {
        plantName: "산세베리아",
        type: "다육식물",
        image: "https://cdn.pixabay.com/photo/2023/11/20/19/13/ai-generated-8401733_1280.jpg",
        content: "추위에 약하고, 물을 자주 주면 해롭습니다, 겨울에는 2개월에 한번씩 물을 주는게 좋습니다.",
        tag: "#상쾌한"
    },
    {
        plantName: '금전수',
        type: '금전초아과',
        image: 'https://t0.gstatic.com/licensed-image?q=tbn:ANd9GcRCo87P_ftdWeWEAjvP2hupDCFVkDriH2FmZmHdnw7KTfEFCEtsA1Jd8erfPUR7fcss',
        content: '밝은 곳에서 키우는게 좋지만 그늘진 곳도 잘 견딘다. 어떤 환경이든 잘 자라지만 과습한 상태에서 저온상태가 되면 뿌리가 썩기 쉽다.',
        tag: ''
    },
    {
        plantName: '라벤더',
        ...
        content: '햇빛을 좋아하며 어떤 환경에서도 잘 자라지만, 너무 습하거나 저온이 될 경우 뿌리가 썩을 수 있습니다. 꽃말은 침묵',
        tag: '#향기로운'
    },
    {
        plantName: '베고니아',
        type: '베고니아과',
        image: 'https://www.nongsaro.go.kr/cms_contents/301/13201_MF_REPR_ATTACH_01.jpg',
        content: '다양한 색상과 모양의 아름다운 꽃을 피우며 그늘에서도 잘 자라는 식물로, 사랑과 감사의 꽃말을 갖고 있습니다.',
        tag: '#낭만적인'
    },
    {
        plantName: '수염 틸란',
        type: '틸란드시아',
        image: 'https://cdn.pixabay.com/photo/2017/08/13/12/10/parasitic-plants-2636989_1280.jpg',
        content: '잎과 줄기가 아래쪽을 향해서 자라나는 독특한 형태의 인기종 입니다. 분무기를 사용해서 자주 물을 주세요!',
        tag: '#특별한'
    },
    {
        plantName: '이오난사',
        type: '틸란드시아',
        image: 'https://cdn.pixabay.com/photo/2019/06/17/08/24/pastel-4279380_1280.jpg',
        content: '반그늘 상태에서 관리하면 좋습니다. 물은 2~3일에 한번 물을 주세요. 최저 기온이 10도 이하일 경우 아침에 한번!',
        tag: '#수수한 '
    },
    {
        plantName: '시아네아',
        type: '틸란드시아',
        image: 'https://m.simpol.co.kr/data/shopimages/product/302423813/202310/0030080000000040072.jpg',
        content: '반 그늘 상태 에서 관리하면 좋습니다 ! 물은 1~2일에 한번씩 물을 주세요 ! ',
        tag: '#특별한 '
    },
    {
        plantName: '스노우사파이어',
        type: '아글라오네마',
        image: 'https://images.unsplash.com/photo-1659100057003-0fe3e5da816d?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjJ8fCVFQyU5NSU4NCVFQSVCOCU4MCVFQiU5RCVCQyVFQyU5OCVBNCVFQiU4NCVBNCVFQiVBNyU4OHxlbnwwfHwwfHx8MA%3D%3D',
    ...
    },
    {
        plantName: '시암 오로라',
        type: '아글라오네마',
        image: 'https://cdn.pixabay.com/photo/2023/06/18/16/21/aglaonema-8072386_1280.jpg',
        content: '반 그늘 상태 에서 관리하면 좋습니다 ! 물은 일주일에 1~2번씩 물을 주세요 ! ',
        tag: ''
    },
    {
    ...
    },
    {
        plantName: '콜로카시아',
        type: '관엽식물',
        image: 'https://images.unsplash.com/photo-1609904212606-740ed5e2b6a4?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8JUVDJUJEJTlDJUVCJUExJTlDJUVDJUI5JUI0JUVDJThCJTlDJUVDJTk1JTg0fGVufDB8fDB8fHww',
        content: '빛을 좋아해서 여름에는 실외가 좋습니다 ! 구멍없는 화분에 흙 위로 물이 조금 차도록 해서 키우는게 좋습니다 !',
        tag: '#특별한'
    },
    {
        plantName: '콜레우스',
        type: '관엽식물',
        image: 'https://images.unsplash.com/photo-1592690800687-8d39fa1057ac?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8JUVDJUJEJTlDJUVCJUEwJTg4JUVDJTlBJUIwJUVDJThBJUE0fGVufDB8fDB8fHww',
        content: '풍부한 햇빛을 받으면 화려한 잎을 볼 수 있어요! 일주일에 한번 정도 이지만 토양의 상태를 확인하고 물을 주는것 또한 좋습니다.',
        tag: ''
    },
    {
        plantName: '베고니아 타마야',
        type: '관엽식물',
        image: 'https://images.unsplash.com/photo-1636303651143-6729d2cda3c7?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjZ8fCVFQiVCMiVBMCVFQSVCMyVBMCVFQiU4QiU4OCVFQyU5NSU4NHxlbnwwfHwwfHx8MA%3D%3D',
        content: '일반적인 실내 공간의 빛 ! 일주일에 한번 정도 이지만 토양의 상태를 확인하고 물을 주는것 또한 좋습니다.',
        tag: ''
    },
    {
